...
define(['N/record','N/search','N/format'],
    ...
    function(record,search,format) {
         ...
         * @since 2015.1
         */
        function map(context) { //El map se ejecuta despues del getinputdata, en el context viene como un JSON en formato de texto con los valores de la busqueda, cada resultado de la bsuqueda representa una ejecución del map, es decir si la busqueda tiene 13 lineas, el metodo map se ejecutará 13 veces.
            ...
            try{
                ...
                context.write({
                    key: peticion,
                    value: datos.values
                });//MAP no tiene return, este metodo hace que pase la información hacia el reduce, el objetivo principal de esta funcion es agrupar datos, por ejemplo agrupar las líneas de la busqueda que pertenecen a la misma transacción. Key es el dato que los agrupa y value son los datos que vas a procesar.
            }catch(error){
         ...
         * @since 2015.1
         */
        function reduce(context) {//Redcue se ejecuta si el map regreso grupos, y el context tiene un arreglo con todos los datos que se agruparon porque tenían el mismo key. Normalmente aquí se hace los procesos, calculos o envio de información.
         ...
         * @since 2015.1
         */
        function summarize(summary) {//Solo te muestra el resumen de cuanto tiempo se tardó en ejecutarse, es informativo
