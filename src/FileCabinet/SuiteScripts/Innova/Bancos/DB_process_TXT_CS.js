 ...
 */
define(['N/https', 'N/record','N/currentRecord','N/url','N/ui/message'],
/**
 * @param{http} http
 * @param{record} record
 */
function(https, record,currentRecord,urlMod,message) {
    ...
    function reprocesar(registro){
        ...
        var myMsg = message.create({
            title: "Reprocesando",
            message: "El archivo se está reprocesando.",
